package org.ranji.lemon.volador.service.auth.impl;

import java.util.List;

import org.ranji.lemon.core.service.impl.GenericServiceImpl;
import org.ranji.lemon.volador.model.auth.Role;
import org.ranji.lemon.volador.persist.auth.prototype.IRoleDao;
import org.ranji.lemon.volador.service.auth.prototype.IRoleService;
 ...
 * @version 1.0
 */
@Service("VoladorRoleServiceImpl") //-- 为解决其他项目中也有项目的类名，则利用@Autowired自动注入冲突的问题
